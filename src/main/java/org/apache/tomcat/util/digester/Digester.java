...
public class Digester extends DefaultHandler2 {
    ...
    protected static PropertySource[] propertySources;
    ...
    static {
        ...
        if (classNames != null) {
            ...
            sources = sourcesList.toArray(new PropertySource[0]);
        }
        if (sources != null) {
    ...
    public static void setPropertySource(PropertySource propertySource) {
        if (!propertySourcesSet) {
            propertySources = new PropertySource[1];
            propertySources[0] = propertySource;
            propertySourcesSet = true;
        }
    }

    public static void setPropertySource(PropertySource[] propertySources) {
        if (!propertySourcesSet) {
    ...
    /**
     * A {@link IntrospectionUtils.SecurePropertySource}
    ...
    public Digester() {
        ...
        source = sourcesList.toArray(new PropertySource[0]);
    }
